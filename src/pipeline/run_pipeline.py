...
# Make `src/` importable regardless of the current working directory or
# whose machine this runs on (previously hard-coded to one developer's
# home directory, which broke for anyone else / on a server).
